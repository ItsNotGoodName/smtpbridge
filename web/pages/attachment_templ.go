...
func attachmentListView(m meta.Meta, props attachmentListViewProps) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		...
		var_2 := templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
			...
			_, err = templBuffer.WriteString("</li></ul></div> <div class=\"flex flex-col gap-4 p-4\"><div class=\"join flex items-center justify-end\" data-loading-states><button title=\"Remove Orphan Attachments\" class=\"btn-sm btn btn-info join-item\" hx-post=\"")
			if err != nil {
				return err
			}
