...
func newEndpointsTableImpl(schemaName, tableName, alias string) endpointsTable {
	var (
		...
		allColumns              = sqlite.ColumnList{IDColumn, InternalColumn, InternalIDColumn, NameColumn, AttachmentDisableColumn, TextDisableColumn, BodyTemplateColumn, KindColumn, ConfigColumn, UpdatedAtColumn, CreatedAtColumn}
		mutableColumns          = sqlite.ColumnList{InternalColumn, InternalIDColumn, NameColumn, AttachmentDisableColumn, TextDisableColumn, BodyTemplateColumn, KindColumn, ConfigColumn, UpdatedAtColumn, CreatedAtColumn}
	)
